...
<html lang="es">
    ...
    <body class="appear-animate">
        ...
        <div class="page" id="top">
                        ...
                        <div class="home-content">
                            <div class="home-text">
                                ...
                                <h1 class="hs-line-8 no-transp font-alt mb-50 mb-xs-30">
                                    Creamos soluciones para todos
                                </h1>
                                
                                <h2 class="hs-line-7 mb-50 mb-xs-30">
                                    <span class="text-rotate">
                                        Genera tu CV en 3 pasos,
                                        Resultados profesionales,
                                        Inscribite en la Unsta
                                    </span>
                                </h2>
                            </div>
                        </div>
            ...
            <!-- Buy Button -->
            <a href="http://themeforest.net/item/rhythm-multipurpose-onemulti-page-template/10140354?ref=Bestlooker" target="_blank" class="buy-button"><i class="fa fa-shopping-cart" aria-hidden="true"></i> <span>Buy</span></a>
            <!-- End Buy Button -->
